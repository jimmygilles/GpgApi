...
{
    /// <summary>
    /// The exception is thrown when a new instance of <see cref="GpgApi.Email"/> is initialized with an invalid email address.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GpgApi.InvalidEmailAddressException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GpgApi.InvalidEmailAddressException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GpgApi.InvalidEmailAddressException"/> class with serialized data.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GpgApi.InvalidEmailAddressException"/> class with a specified error message and the exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The error message that explains the reason for this exception.</param>
